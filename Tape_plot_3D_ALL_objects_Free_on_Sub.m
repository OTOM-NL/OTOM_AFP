...
function [h_T]=Tape_plot_3D_ALL_objects_Free_on_Sub(N,W,R,L_flat,tv,th_y,thick_T,deg_T,W_R,theta_ind,R_cyl,z_cyl_end,H_indentation)



if R_cyl (1) ~=0
%%
[Rot_Roller_axis,~]=Rot_Matrix_Finder_RollerTape(tv,th_y,R_cyl,z_cyl_end);
