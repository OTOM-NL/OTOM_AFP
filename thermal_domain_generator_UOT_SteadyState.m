...
function thermal_domain_generator_UOT_SteadyState(th_y,W_tape,thick_T,R_tape,L_flat,deg_tape,...
    ...
    text_status,Points_in_domain_all_sub,Points_in_domain_all_Tape,Tape_points_Data,step_UOT_steadystate)
...
steps=step_UOT_steadystate; %length(nip_point_M_all);
...
for ss=step_UOT_steadystate:step_UOT_steadystate
...
%         E_points_T( n(4))=E*Weight(4) +  E_points_T( n(4));
    ...
    %% Show part
        ...
        X_T=zeros(ynode_T,xnode_T);
        Y_T=zeros(ynode_T,xnode_T);
        Z_T=zeros(ynode_T,xnode_T);
        Intensity_T=zeros(ynode_T,xnode_T);
    
        for kk=1:ynode_T
            index=((1:xnode_T)*ynode_T)-kk+1;
...
Tape_ele_size=delta_x_T*delta_y_T;
    Tecplot_Matlab_creator_2D (ss,N_plane,xnode,ynode,Velocity,Lx,Ly,E_points/sub_ele_size,fileID_Tecplot_PowerIntensity_UOT_sub);
    Tecplot_Matlab_creator_2D (ss,N_T,xnode_T,ynode_T,Velocity,Lx_T,Ly_T,E_points_T/Tape_ele_size,fileID_Tecplot_PowerIntensity_UOT_Tape);
...
%         indexxy_T);
       ...
       [T_matrix_Sub_Tape,T_old, T_old_T]= UOT_FDM_2D_3D_SteadyState_TapeANDSub_combined(Lx,Ly,Lz,xnode,ynode,znode,E_points,Velocity,materials_sub,Temp_Right_sub(1),h_conv_Sub,...
        T_amb_mandrel,Rel_v_theta,Measure_Box_Sub,fileID_Temp_Red_Box_Sub,Graphic_chekbox(2),Graphic_chekbox(5),Graphic_chekbox(6),...
        Live_output,init_Temp,Inc_transient,Time_transient,...
        Lx_T,Ly_T,xnode_T,ynode_T,E_points_4_adv_func_T,Velocity_T,materials_Tape,Temp_roller_current,h_conv_T,thick_T,Row_number_Tape_Roller_tangent,Measure_Box_Tape,fileID_Temp_Red_Box_Tape,...
        Graphic_chekbox (3),Graphic_chekbox (4),Graphic_chekbox(2),...
