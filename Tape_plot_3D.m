...
function [n1,n2,n3,x0,y0,z0,h_R,h_T,Center_roller]=Tape_plot_3D(N,W,R,L_flat,tv,th_y,thick_T,deg_T,W_R,theta_ind,Rot_plane,H_indentation,tv_def)
...
% h3=surf(X_G,Y_G,Z_G,'FaceColor',[0.278 0.788 0.788]);
    ...
    h_T= []; %[h2,h3]; %for the flat and curved part of the tape
