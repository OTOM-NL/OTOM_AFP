...
function Inline_thermal_domain_generator_Tr(th_y,W_tape,thick_T,R_tape,L_flat,deg_tape,...
    ...
    Temp_Right_sub,Temp_Right_T_Roller,h_conv_Sub,h_conv_T,H_indentation,Node_z_3D_thermal,T_amb_mandrel,....
       ...
       Live_output=Inline_ID(2);
       init_Temp=Inline_ID(3);
       Inc_transient=Inline_ID(4);
       Time_transient=Inline_ID(5);
       Video_transient=Inline_ID(6);
   
       
       
%       Turn off graphical representation
  Total_energy=1;
              Graphic_chekbox(1)=1;
           Graphic_chekbox(2:end)=0;
...
%%  Temperature calculation
              ...
              T_matrix_Sub_Tape= Inline_FDM_2D_3D_transient_TapeANDSub_combined(Ly,Lx,Lz,ynode,xnode,znode,E_points,materials_sub,Temp_Right_sub(1),h_conv_Sub,...
  T_amb_mandrel,Rel_v_theta,Measure_Box_Sub,fileID_Temp_Red_Box_Sub,Graphic_chekbox(2),Graphic_chekbox(5),Graphic_chekbox(6),...
             ...
             Ly_T,Lx_T,ynode_T,xnode_T,E_points_4_adv_func_T,materials_Tape,Temp_Right_T_Roller,h_conv_T,thick_T,Row_number_Tape_Roller_tangent,Measure_Box_Tape,fileID_Temp_Red_Box_Tape,...
...
% T_matrix_T=thermal_advection_comb_Tape_FEM(Ly_T,Lx_T,ynode_T,xnode_T,E_points_4_adv_func_T,Velocity,materials_Tape,Temp_Right_T_Roller,h_conv_T,thick_T);
