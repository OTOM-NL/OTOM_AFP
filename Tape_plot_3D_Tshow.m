...
function [n1,n2,n3,x0,y0,z0,h_R,h_T,Center_roller]=Tape_plot_3D_Tshow(N,W,R,L_flat,tv,th_y,thick_T,deg_T,W_R,theta_ind,Rot_plane,H_indentation,tv_def)


% THE WAY THAT I SHOW THE CONFIGURATION
...
Temp2=Rot_plane*[xo_text;yo_text;zo_text];
xo_text=Temp2(1,:);
yo_text=Temp2(2,:);
zo_text=Temp2(3,:);

xo_text=xo_text+tv_x;%-tv_def(1) ;  % Sth was wrong in probabely implementation that's why all shitty stupid change is done
yo_text=yo_text+tv_y;%+tv_def(2) ;
zo_text=zo_text+tv_z;%+tv_def(3) ;


h_axis=plot3(xo_points, ...
       yo_points, ...
      zo_points , 'k--');
...
Temp=Rot_plane*[x(1,i);y(1,i);z(1,i)];
Temp2=Rot_plane*[x(2,i);y(2,i);z(2,i)];
...
for i=1:size(x_R,2)
   Temp_R=Rot_plane*[x_R(1,i);y_R(1,i);z_R(1,i)];
Temp2_R=Rot_plane*[x_R(2,i);y_R(2,i);z_R(2,i)];
...
%%
 ...
 h3=surf(X_G,Y_G,Z_G,'FaceColor',[0.278 0.788 0.788]);

    h_T= [h2,h3,h_axis,h_text']; %for the flat and curved part of the tape
